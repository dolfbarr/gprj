...
gprj/0.6.1 darwin-x64 node-v14.17.3
$ gprj --help [COMMAND]
USAGE
  $ gprj COMMAND
...
...
_See code: [src/commands/add.ts](https://github.com/dolfbarr/gprj/blob/v0.6.1/src/commands/add.ts)_
...
_See code: [src/commands/list.ts](https://github.com/dolfbarr/gprj/blob/v0.6.1/src/commands/list.ts)_
...
_See code: [src/commands/remove.ts](https://github.com/dolfbarr/gprj/blob/v0.6.1/src/commands/remove.ts)_
<!-- commandsstop -->
